...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("LSPDRP Server Status", "https://cdn.discordapp.com/attachments/723596605344841750/746013645988692038/lspd4.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ LSPDRP' : '⚫ LSPDRP')
    .setTimestamp(new Date())
    .addField('\n\u200b\nLSPDRP LIVE SERVER STATUS','Official Patrol Time is Saturdays at 6PM EST. Check announcments for more information!',false)
    if (STATUS !== undefined)
    {
